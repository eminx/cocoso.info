...
const resources = [
  ...
  `At Cocoso software, there are no calendar invites. Because, we believe that machines should only help us facilitate our own communications and sharing - not operate and act for us. Cocoso’s calendar is the main facade of community events and resource sharing. We also like so much that people talk to each other as much as we free our emails from data clutter.`,
